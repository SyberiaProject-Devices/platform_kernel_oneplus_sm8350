 ...
 */
inline void uclamp_rq_inc_id_mod(struct rq *rq, struct task_struct *p,
 ...
 */
inline void uclamp_rq_dec_id_mod(struct rq *rq, struct task_struct *p,
				    enum uclamp_id clamp_id)
{
	struct uclamp_rq *uc_rq = &rq->uclamp[clamp_id];
	struct uclamp_se *uc_se = &p->uclamp[clamp_id];
...
uclamp_update_active(struct task_struct *p, enum uclamp_id clamp_id)
{
	...
	if (p->uclamp[clamp_id].active) {
		uclamp_rq_dec_id_mod(rq, p, clamp_id);
		uclamp_rq_inc_id_mod(rq, p, clamp_id);
	}
