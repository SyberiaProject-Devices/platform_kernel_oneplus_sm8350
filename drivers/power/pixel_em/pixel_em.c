...
#if IS_ENABLED(CONFIG_VENDOR_SCHED)
extern struct em_perf_domain **vendor_sched_cpu_to_em_pd;
#endif

#if IS_ENABLED(CONFIG_CPU_THERMAL)
extern struct em_perf_domain **pixel_cpu_cooling_cpu_to_em_pd;
#endif
...
#if IS_ENABLED(CONFIG_CPU_THERMAL)
	pr_info("Publishing PDs to pixel_cpu_cooling!\n");
	WRITE_ONCE(pixel_cpu_cooling_cpu_to_em_pd, cpu_to_em_pd);
#endif
