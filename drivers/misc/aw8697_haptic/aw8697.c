...
#define AW8697_CONTAINER_DEFAULT_SIZE (2 * 1024 * 1024)
...
static void aw8697_update_sin_rtp_data(struct aw8697 *aw8697)
{
	...
	aw8697->sin_data_lenght =
		(size_t)(aw8697->sin_num * ONE_SINE_DATA_LENGHT);
}
...
static int aw8697_haptic_get_f0(struct aw8697 *aw8697)
{
	...
	aw8697_dump_f0_registers(aw8697);
				...
				size_t count)
{
	...
	if (aw8697->device_id == 1815 && val >= OPLUS_START_INDEX &&
			val <= OPLUS_END_INDEX) {
		/* */
		val = val - 30;
	}
