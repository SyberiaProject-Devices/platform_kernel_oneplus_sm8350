...
extern unsigned int sysctl_sched_silver_thres;
...
extern unsigned int sysctl_sched_util_busy_hyst_cpu[NR_CPUS];
extern unsigned int sysctl_sched_util_busy_hyst_cpu_util[NR_CPUS];
